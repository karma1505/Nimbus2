  ...
  return (
    <section
      className={`bg-black text-white min-h-screen flex flex-col ${
        typeof window !== "undefined" && scrollPosition > window.innerHeight
          ? "bg-blue-600"
          : "bg-transparent"
      }`}
    >
      <nav
        className={`fixed top-0 left-0 w-full p-4 flex justify-between items-center z-50 bg-black bg-opacity-30 backdrop-blur-md ${
          typeof window !== "undefined" && scrollPosition > window.innerHeight
            ? "bg-opacity-60"
            : "bg-opacity-30"
        }`}
      >
        ...
        <div className="hidden md:flex space-x-6">
          <a href="#home" className="hover:text-blue-300" onClick={scrollToTop}>
            Home
          </a>
          <a href="#services" className="hover:text-blue-300" onClick={scrollToServices}>
            Services
          </a>
          <a href="#about" className="hover:text-blue-300" onClick={scrollToAbout}>
            About
          </a>
          <a href="#contact" className="hover:text-blue-300" onClick={scrollToServices}>
            Contact
          </a>
        </div>
      ...
      <div className="flex-grow flex items-center justify-center">
        <div className="container mx-auto px-4 text-center">
          {/* Added margin-top to move image higher */}
          <div className="flex justify-center">
            <Image
              ...
              width={200}
              height={200}
              className="object-contain max-w-full h-auto mb-36"
            />
          </div>
          ...
          <p className="text-lg md:text-xl mb-8 mt-8">
            Elevate Your Online Presence: Tailored Websites, Strategic Ads, and
            SEO Excellence.
          </p>
          <button
