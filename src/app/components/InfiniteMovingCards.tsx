...
const InfiniteMovingCards: React.FC<TestimonialsProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "scroller relative z-20 w-full overflow-hidden [mask-image:linear-gradient(to_right,transparent,white_20%,white_80%,transparent)] py-16 px-6 md:py-32 md:px-20 mx-auto",
        className
      )}
    >
      <ul
