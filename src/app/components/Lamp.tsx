...
export const Lamp = () => {
  return (
    <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-70 overflow-hidden"> {/* Changed z-index here */}
      <motion.div
      ...
      <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-black blur-2xl z-0"></div> {/* Adjusted z-index */}
